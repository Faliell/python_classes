...
# Criação do botão de movimento
movimentar_button = tk.Button(root, text="Iniciar Movimento", command=movimentar)
movimentar_button.grid(row=3, column=2, padx=10, pady=10)
